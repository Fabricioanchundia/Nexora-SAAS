...
export class Invoice {
  ...
  @Column({ name: 'discount_total', type: 'decimal', precision: 14, scale: 2, default: 0 }) discountTotal!: number;
  @Column({ name: 'tax_amount', type: 'decimal', precision: 14, scale: 2, default: 0 }) taxAmount!: number;
  ...
  @OneToOne(() => TaxDocument, (td) => td.invoice) taxDocument!: TaxDocument;
}
