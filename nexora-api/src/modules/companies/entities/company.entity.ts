...
export class Company {
  ...
  @Column({ name: 'trade_name', length: 300, nullable: true }) tradeName!: string | null;
  @Column({ length: 500 }) address!: string;
  @Column({ name: 'establishment_address', length: 500, nullable: true }) establishmentAddress!: string | null;
  ...
  @Column({ name: 'special_contributor_code', length: 10, nullable: true }) specialContributorCode!: string | null;
