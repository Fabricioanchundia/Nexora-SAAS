...
export class Company {
  ...
  @Column({ name: 'trade_name', type: 'varchar', length: 300, nullable: true }) tradeName!: string | null;
  @Column({ length: 500 }) address!: string;
  @Column({ name: 'establishment_address', type: 'varchar', length: 500, nullable: true }) establishmentAddress!: string | null;
  ...
  @Column({ name: 'sri_environment', type: 'enum', enum: EnvironmentType, default: EnvironmentType.PRUEBAS }) sriEnvironment!: EnvironmentType;
  @Column({ name: 'emission_type', type: 'enum', enum: EmissionType, default: EmissionType.NORMAL }) emissionType!: EmissionType;
  ...
  @Column({ name: 'obligado_contabilidad', default: false }) obligadoContabilidad!: boolean;
  @Column({ name: 'special_contributor_code', type: 'varchar', length: 10, nullable: true }) specialContributorCode!: string | null;
