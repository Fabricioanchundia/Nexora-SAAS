...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>,
  },
  {
  ...
  },
  {
    ...
    icon: <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>,
  },
  {
    label: 'Empresas', href: '/dashboard/companies',
    icon: <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>,
  },
  {
  ...
  },
  {
    ...
    icon: <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
  },
] as const;
  ...
  return (
    <button
      ...
      style={{
        ...
        fontFamily: 'inherit', marginBottom: '4px', transition: 'background 0.15s',
      }}
    ...
    >
      ...
      <div style={{
        ...
        background: dark ? '#3B82F6' : 'rgba(255,255,255,0.15)',
      ...
      <span style={{ fontSize: '12.5px', fontWeight: 500, color: 'rgba(255,255,255,0.5)' }}>
    ...
    <>
      <style>{`
        ...
        .nx-dark {
          ...
          --badge-gray-color: rgba(255,255,255,0.5);
        }

        /* ── Layout ── */
        .nx-layout  { display:flex; min-height:100vh; background:var(--main-bg); font-family:var(--font-sans,system-ui,sans-serif); transition:background 0.25s; }
        ...
        .nx-brand-logo-wrap { display:flex; align-items:center; justify-content:center; padding:14px 16px 10px; background:linear-gradient(160deg,#0d1e3d,#112347); }
        .nx-brand-logo-inner { background:#fff; border-radius:12px; padding:6px 14px; display:inline-flex; align-items:center; justify-content:center; box-shadow:0 2px 12px rgba(0,0,0,0.3); }
        .nx-brand-sub-row  { display:flex; align-items:center; justify-content:center; gap:6px; padding:7px 16px 10px; background:linear-gradient(160deg,#112347,#0d1e3d); }
        ...
        .nx-theme-btn:hover { background:rgba(255,255,255,0.05) !important; }
        ...
        /* Main */
        .nx-main { margin-left:var(--sb-width); flex:1; min-height:100vh; overflow:auto; transition:background 0.25s; }

        /* ── Variables de tema aplicadas a componentes del dashboard ── */

        /* Cards */
        .nx-dark .nx-card,
        .nx-dark [style*="background: '#fff'"],
        .nx-dark [style*="background:'#fff'"] {
        ...
        /* Textos primarios */
        .nx-dark h1, .nx-dark h2, .nx-dark h3,
        .nx-dark [style*="color: '#0F172A'"],
        .nx-dark [style*="color:'#0F172A'"] {
          color: var(--text-primary) !important;
        }

        /* Textos secundarios */
        .nx-dark [style*="color: '#64748B'"],
        .nx-dark [style*="color:'#64748B'"],
        .nx-dark [style*="color: '#475569'"],
        .nx-dark [style*="color:'#475569'"] {
        ...
        /* Inputs */
        .nx-dark input, .nx-dark select, .nx-dark textarea {
        ...
        /* Tablas */
        .nx-dark table { color: var(--text-primary); }
        .nx-dark th    { background: var(--table-head) !important; color: var(--text-muted) !important; }
        .nx-dark tr:hover td { background: var(--table-hover) !important; }

        /* Badges grises */
        .nx-dark [style*="background: '#F8FAFC'"],
        .nx-dark [style*="background:'#F8FAFC'"],
        .nx-dark [style*="background: '#F1F5F9'"],
        .nx-dark [style*="background:'#F1F5F9'"] {
          background: var(--badge-gray-bg) !important;
        }

        /* Bordes */
        .nx-dark [style*="borderColor: '#E2E8F0'"],
        .nx-dark [style*="border: '1px solid #E2E8F0'"],
        .nx-dark [style*="borderBottom: '1px solid #F8FAFC'"] {
          border-color: var(--divider) !important;
        }
      `}</style>

      <div className={`nx-layout${dark ? ' nx-dark' : ''}`}>
        <aside className="nx-sidebar">
          ...
          <nav className="nx-nav" aria-label="Navegación principal">
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <NavItem key={item.href} label={item.label} href={item.href} icon={item.icon} isActive={isActive} onNavigate={handleNavigate} />
              );
            })}
          </nav>
