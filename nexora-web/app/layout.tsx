...
// S6759: extracted — avoids inline onClick factory in .map()
  ...
  return (
    <>
      <style>{`
        ...
        .nx-sidebar { width:var(--sidebar-width); background:var(--sidebar-bg); border-right:1px solid var(--sidebar-border); display:flex; flex-direction:column; position:fixed; top:0; left:0; bottom:0; z-index:40; }
        .nx-brand { display:flex; align-items:center; gap:10px; padding:20px 18px 18px; border-bottom:1px solid var(--sidebar-border); }
        .nx-logo { width:34px; height:34px; background:linear-gradient(135deg,#1D4ED8 0%,#3B82F6 100%); border-radius:9px; display:flex; align-items:center; justify-content:center; font-size:15px; font-weight:800; color:#fff; flex-shrink:0; box-shadow:0 0 12px rgba(59,130,246,0.35); }
        .nx-brand-name { font-size:14px; font-weight:700; letter-spacing:0.08em; color:#fff; line-height:1; display:block; }
        .nx-brand-sub { font-size:10px; color:var(--text-muted); display:block; margin-top:3px; }
        .nx-nav { flex:1; padding:16px 10px; display:flex; flex-direction:column; gap:2px; overflow-y:auto; }
        .nx-nav-label { font-size:9.5px; font-weight:600; letter-spacing:0.1em; color:var(--text-muted); padding:0 10px; margin:0 0 8px; text-transform:uppercase; }
        .nav-item { display:flex; align-items:center; gap:10px; width:100%; padding:9px 10px; border-radius:8px; font-size:13.5px; font-weight:400; color:var(--text-secondary); background:transparent; border:none; cursor:pointer; text-align:left; transition:all 0.15s ease; }
        ...
        .nx-user { padding:12px 10px 16px; border-top:1px solid var(--sidebar-border); }
        ...
        .nx-user-name { font-size:12.5px; font-weight:500; color:var(--text-primary); margin:0; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:140px; }
        .nx-user-role { font-size:10.5px; color:var(--text-muted); margin:0; }
        ...
        .nx-main { margin-left:var(--sidebar-width); flex:1; min-height:100vh; overflow:auto; }
      `}</style>
